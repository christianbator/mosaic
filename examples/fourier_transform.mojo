...
fn main():
    try:
        ...
        var spectral_image = Image[DType.float64, ColorSpace.greyscale](normalized_spectrum^)

        # Step 7: Horizontally stack the original image and its spectrum for visualization
        var stacked = image.horizontally_stacked(spectral_image.astype[DType.uint8]())
