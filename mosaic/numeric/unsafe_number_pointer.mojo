...
struct UnsafeNumberPointer[dtype: DType, *, complex: Bool]:
    ...
    fn load[width: Int](self, index: Int) -> Number[dtype, width, complex=complex]:
        @parameter
        if complex:
    ...
    fn strided_load[width: Int](self, index: Int, stride: Int) -> Number[dtype, width, complex=complex]:
        @parameter
        if complex:
            return Number[dtype, width, complex=complex](
    ...
    fn gather[
        width: Int, //
    ](self, index: Int, offset_vector: SIMD[DType.index, width], mask_vector: SIMD[DType.bool, width],) -> Number[dtype, width, complex=complex]:
        @parameter
        if complex:
            return Number[dtype, width, complex=complex](
            ...
            return Number[dtype, width, complex=complex](
                rebind[Number[dtype, width, complex=complex].Value](self._data.offset(index).gather(offset=offset_vector, mask=mask_vector))
            )
